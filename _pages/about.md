...
# Research
My research develops mathematical optimization and AI methods for conservation and natural resource decision-making. Three threads run through it: optimization for conservation planning, LLM-powered tools that make complex spatial data usable, and how those tools shape policy and practice. I codevelop these as <a href="/software/">open-source decision-support tools</a> with practitioners and stakeholders, helping users prioritize where to protect land, where to invest, and how to track policy progress. <a href="/projects/">Recent projects</a> span state to international scales — California's 30x30, the Greater Yellowstone Ecosystem, and the High Seas Treaty. 
